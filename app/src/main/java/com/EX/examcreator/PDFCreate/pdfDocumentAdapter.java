...
public class pdfDocumentAdapter extends PrintDocumentAdapter {
    ...
    @Override
    public void onLayout(PrintAttributes prinAttributes, PrintAttributes PrintAttributes1, CancellationSignal cancellationSignal, LayoutResultCallback layoutResultCallback, Bundle extras) {
    if (cancellationSignal.isCanceled())
    ...
    else
     {
         ...
         builder.setContentType(PrintDocumentInfo.CONTENT_TYPE_DOCUMENT)
                 ...
                 .build();
         layoutResultCallback.onLayoutFinished(builder.build(),!PrintAttributes1.equals(prinAttributes));
    }
